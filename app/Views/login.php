...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" media="screen, print" href="<?php echo base_url('css/fa-brands.css'); ?>">
    </head>
    <!-- BEGIN Body -->
    <!-- Possible Classes
                ...
                <div class="page-content-wrapper bg-transparent m-0">
                    <div class="height-10 w-100 shadow-lg px-4 bg-brand-gradient">
                        <div class="d-flex align-items-center container p-0">
                            ...
                            <a href="<?php echo base_url('register'); ?>" class="btn-link text-white ml-auto">
                                Create Account
                            </a>
                        </div>
                    </div>
                    <div class="flex-1" style="background: url(<?php echo base_url('img/svg/pattern-1.svg'); ?> no-repeat center bottom fixed; background-size: cover;">
