...
<div class="page-content-overlay" data-action="toggle" data-class="mobile-nav-on"></div> <!-- END Page Content -->
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <ul class="app-list w-auto h-auto p-0 text-left">
                                        ...
                                        <li>
                                            <a href="<?php echo base_url('/user/view'); ?>" class="app-list-item text-white border-0 m-0">
                                                <div class="icon-stack">
                                        ...
                                        <li>
                                            <a href="<?php echo base_url('/user/register'); ?>" class="app-list-item text-white border-0 m-0">
                                                <div class="icon-stack">
                                                    <i class="base base-7 icon-stack-2x opacity-100 color-primary-300 "></i>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url('/logout'); ?>" class="app-list-item text-white border-0 m-0">
                                                <div class="icon-stack">
                                                    <i class="base base-7 icon-stack-2x opacity-100 color-primary-300 "></i>
                                                    <i class="fal fa-trash icon-stack-1x opacity-100 color-white"></i>
                                                </div>
                                                <span class="app-list-name">
                                                    Exit
                                                </span>
        ...
        <script src="<?php echo base_url('js/statistics/peity/peity.bundle.js'); ?>"></script>
        <script src="<?php echo base_url('js/statistics/flot/flot.bundle.js'); ?>"></script>
        <script src="<?php echo base_url('js/statistics/easypiechart/easypiechart.bundle.js'); ?>"></script>
                    ...
                    columnDefs: [
                        {
                            ...
                            // {
                                ...
                                */
                                return "\n\t\t\t\t\t\t<a href='<?php echo base_url('user/delete'); ?>' class='btn btn-sm btn-icon btn-outline-danger rounded-circle mr-1' title='Delete Record'>\n\t\t\t\t\t\t\t<i class=\"fal fa-times\"></i>\n\t\t\t\t\t\t</a>";
                            // },
                        },
